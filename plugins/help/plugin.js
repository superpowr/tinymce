...
var help = (function () {
  ...
  var never$1 = $_aytbksaqjeajoito.never;
  var always$1 = $_aytbksaqjeajoito.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_aytbksaqjeajoito.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var $_qi6okasjeajoitq = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = $_e8j1uiaojeajoitf.map($_qi6okasjeajoitq.shortcuts, function (shortcut) {
  ...
  var $_bsjn08anjeajoita = { makeTab: makeTab };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_aipzozaxjeajoiue.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_aipzozaxjeajoiue.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_aipzozaxjeajoiue.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_aipzozaxjeajoiue.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_dw2csmayjeajoiug.head(str).bind(function (head) {
      return $_dw2csmayjeajoiug.tail(str).map(function (tail) {
  ...
  var $_ey8cmbazjeajoiui = { urls: urls };

  var makeLink = $_aytbksaqjeajoito.curry($_foskbhawjeajoiu7.supplant, '<a href="${url}" target="_blank" rel="noopener">${name}</a>');
  var maybeUrlize = function (editor, key) {
    return $_e8j1uiaojeajoitf.find($_ey8cmbazjeajoiui.urls, function (x) {
      return x.key === key;
    }).fold(function () {
  ...
  var getPluginKeys = function (editor) {
    var keys = $_ctqyx1avjeajoiu2.keys(editor.plugins);
    return editor.settings.forced_plugins === undefined ? keys : $_e8j1uiaojeajoitf.filter(keys, $_aytbksaqjeajoito.not($_aytbksaqjeajoito.curry($_e8j1uiaojeajoitf.contains, editor.settings.forced_plugins)));
  };
  var pluginLister = function (editor) {
    var pluginKeys = getPluginKeys(editor);
    var pluginLis = $_e8j1uiaojeajoitf.map(pluginKeys, function (key) {
  ...
  var $_4papusaujeajoitt = { makeTab: makeTab$1 };
  ...
  var $_dm6umeb0jeajoiuk = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_bsjn08anjeajoita.makeTab(),
          $_4papusaujeajoitt.makeTab(editor)
        ],
        buttons: $_dm6umeb0jeajoiuk.makeRow(),
  ...
  var $_f3cn1xamjeajoit9 = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_f3cn1xamjeajoit9.open(editor, pluginUrl));
  };
  var $_7b4duvaljeajoit7 = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_f3cn1xamjeajoit9.open(editor, pluginUrl)
    });
  ...
  var $_9rjm7fb2jeajoium = { register: register$1 };

  PluginManager.add('help', function (editor, pluginUrl) {
    $_9rjm7fb2jeajoium.register(editor, pluginUrl);
    $_7b4duvaljeajoit7.register(editor, pluginUrl);
