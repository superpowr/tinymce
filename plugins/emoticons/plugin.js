...
var emoticons = (function () {
  ...
  var $_34zzpqahjeajoisw = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_34zzpqahjeajoisw.getHtml(pluginUrl);
  ...
  var $_dkoh7aagjeajoist = { register: register };

  PluginManager.add('emoticons', function (editor, pluginUrl) {
    $_dkoh7aagjeajoist.register(editor, pluginUrl);
  });
  function Plugin () {
  }
