...
var tabfocus = (function () {
  ...
  var $_5ad23zjmjeajok4b = { getTabFocus: getTabFocus };
  ...
  var setup = function (editor) {
    function tabHandler(e) {
      ...
      v = Tools.explode($_5ad23zjmjeajok4b.getTabFocus(editor));
      if (v.length === 1) {
        v[1] = v[0];
        v[0] = ':prev';
      }
  ...
  var $_vjoy5jfjeajok47 = { setup: setup };

  PluginManager.add('tabfocus', function (editor) {
    $_vjoy5jfjeajok47.setup(editor);
  });
  function Plugin () {
  }
