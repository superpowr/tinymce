...
var inlite = (function () {
  ...
  var $_f89oj016ijeajoogd = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_812ugh16mjeajoogh.fromClientRect(clientRect)) : null;
  };
  var $_ft7o3k16ljeajoogg = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          var result = $_ddu0xn16kjeajoogf.result(predicateIds[i].id, $_ft7o3k16ljeajoogg.getElementRect(editor, element));
          return result;
        }
      }
      return null;
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_ddu0xn16kjeajoogf.result(predicateIds[x].id, $_ft7o3k16ljeajoogg.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        var result = $_ddu0xn16kjeajoogf.result(id, $_ft7o3k16ljeajoogg.getSelectionRect(editor));
        return result;
      }
      return null;
    };
      ...
      for (i = 0; i < elements.length; i++) {
        if (elements[i].nodeName in textBlockElementsMap) {
          if (editor.dom.isEmpty(elements[i])) {
            return $_ddu0xn16kjeajoogf.result(id, $_ft7o3k16ljeajoogg.getSelectionRect(editor));
          }
          return null;
        }
      }
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_3838ts16vjeajoogx.isArray(value)) {
      return value;
    } else if ($_3838ts16vjeajoogx.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_3838ts16vjeajoogx.isBoolean(value)) {
  ...
  var $_2p9k3p16ujeajoogv = {
    getStringOr: getByTypeOr($_3838ts16vjeajoogx.isString),
    getBoolOr: getByTypeOr($_3838ts16vjeajoogx.isBoolean),
    getNumberOr: getByTypeOr($_3838ts16vjeajoogx.isNumber),
    getHandlerOr: getByTypeOr($_3838ts16vjeajoogx.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_3838ts16vjeajoogx.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_812ugh16mjeajoogh.toClientRect(targetRect),
        contentAreaRect: $_812ugh16mjeajoogh.toClientRect(contentAreaRect),
        panelRect: $_812ugh16mjeajoogh.toClientRect(panelRect)
      });
      return $_812ugh16mjeajoogh.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_2p9k3p16ujeajoogv.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_2p9k3p16ujeajoogv.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_2p9k3p16ujeajoogv.getHandlerOr(editor, 'inline_toolbar_position_handler', $_3pvs8616wjeajoogy.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_g5ae116rjeajoogl.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_fsb3xs16sjeajoogt.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_fsb3xs16sjeajoogt.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_1q3xsd16qjeajoogk = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_f89oj016ijeajoogd.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_7jebro16njeajoogi.fromContextToolbars(toolbars);
    result = $_ddu0xn16kjeajoogf.match(editor, [
      $_7h1cf216jjeajooge.element(elements[0], contextToolbarsPredicateIds),
      $_3h545016pjeajoogj.textSelection('text'),
      $_3h545016pjeajoogj.emptyTextBlock(elements, 'insert'),
      $_7h1cf216jjeajooge.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_ddu0xn16kjeajoogf.match(editor, [$_3h545016pjeajoogj.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_1q3xsd16qjeajoogk.load(editor, function () {
  ...
  var $_3e4m6z16ejeajoog9 = { renderUI: renderUI };
  ...
  var never$1 = $_c6ztc171jeajoohc.never;
  var always$1 = $_c6ztc171jeajoohc.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_c6ztc171jeajoohc.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_fnpzt3178jeajooi7.parseBox(settings.border);
      self.paddingBox = $_fnpzt3178jeajooi7.parseBox(settings.padding);
      self.marginBox = $_fnpzt3178jeajooi7.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_9rabh917gjeajooiz.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_fnpzt3178jeajooi7.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_fnpzt3178jeajooi7.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_fnpzt3178jeajooi7.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_eh56an17fjeajooiy.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_9rabh917gjeajooiz.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_9rabh917gjeajooiz.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_ci4cir17hjeajooj1 = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_9rabh917gjeajooiz.getUiContainer(self);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_9rabh917gjeajooiz.inheritUiContainer(this, this._tooltip);
  ...
  function NotificationManagerImpl (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_cga97x16zjeajooh4.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_cga97x16zjeajooh4.each(notifications, function (notification, index) {
          if (index > 0) {
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_fnpzt3178jeajooi7.parseBox(self.settings.border);
          ...
          self.borderBox = $_fnpzt3178jeajooi7.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_3e4m6z16ejeajoog9.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_bugvao16djeajoog8 = { get: get };
  ...
  var unsafe = function (name, scope) {
    return $_eylcul180jeajookh.resolve(name, scope);
  };
  ...
  var $_2a4rct17zjeajookf = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_2a4rct17zjeajookf.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_3z7iig17xjeajookc = { blobToBase64: blobToBase64 };
  ...
  var $_zsl6x183jeajooki = { pickFile: pickFile };
  ...
  var $_6ubbsh185jeajookl = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_494tvb187jeajookn.create(dom, selection.getRng());
    Tools.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_494tvb187jeajookn.resolve(dom, bookmark));
  };
  ...
  var $_6vnvo9186jeajookm = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_6ubbsh185jeajookl.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_6vnvo9186jeajookm.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_bph2tq184jeajookj.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_zsl6x183jeajooki.pickFile().then(function (files) {
          var blob = files[0];
          $_3z7iig17xjeajookc.blobToBase64(blob).then(function (base64) {
            $_bph2tq184jeajookj.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_bph2tq184jeajookj.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_1spjsc17wjeajookb = { addToEditor: addToEditor };
  ...
  var $_52yd218bjeajooks = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_e4wyyp18djeajookw.isAbsolute(href) && $_e4wyyp18djeajookw.isDomainLike(href) ? askAboutPrefix(editor, href) : Promise.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_bph2tq184jeajookj.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_bph2tq184jeajookj.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_ejue2f18cjeajooku = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_3838ts16vjeajoogx.isArray(items)) {
      return items;
    } else if ($_3838ts16vjeajoogx.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
    ...
    Tools.each(itemsToArray$1(items), function (item) {
      if (item === '|') {
        ...
        if (editor.buttons[item]) {
          ...
          if ($_3838ts16vjeajoogx.isFunction(button)) {
            button = button();
          }
  ...
  var $_1dl9z018ejeajookw = { create: create$2 };

  var create$3 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return Tools.map(toolbars, function (toolbar) {
        return $_1dl9z018ejeajookw.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_1dl9z018ejeajookw.create(editor, 'text', $_fsb3xs16sjeajoogt.getTextSelectionToolbarItems(editor)),
        $_1dl9z018ejeajookw.create(editor, 'insert', $_fsb3xs16sjeajoogt.getInsertToolbarItems(editor)),
        $_ejue2f18cjeajooku.createQuickLinkForm(editor, hide)
      ]);
      return Factory.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_fsb3xs16sjeajoogt.getPositionHandler(editor);
      contentAreaRect = $_ft7o3k16ljeajoogg.getContentAreaRect(editor);
      panelRect = DOMUtils.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_3pvs8616wjeajoogy.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_3pvs8616wjeajoogy.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_52yd218bjeajooks.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_3pvs8616wjeajoogy.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_ft7o3k16ljeajoogg.getContentAreaRect(editor);
        panelRect = DOMUtils.DOM.getRect(panel.getEl());
        result = $_3pvs8616wjeajoogy.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_3pvs8616wjeajoogy.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_g5ae116rjeajoogl.fireBeforeRenderUI(editor);
  ...
  var $_2lflq7191jeajoomm = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_c6ztc171jeajoohc.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return Option.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_7xp0dh192jeajoomn = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_6cye9r196jeajoomv = { cached: cached };

  var $_bu05sy198jeajoomx = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_bu05sy198jeajoomx.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_bu05sy198jeajoomx.ELEMENT);
  var isText = isType$1($_bu05sy198jeajoomx.TEXT);
  var isDocument = isType$1($_bu05sy198jeajoomx.DOCUMENT);
  var $_fvv2jq197jeajoomw = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_fvv2jq197jeajoomw.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_6cye9r196jeajoomv.cached(function () {
    return getBody($_7xp0dh192jeajoomn.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_7xp0dh192jeajoomn.fromDom(body);
  };
  var $_1pd7f6195jeajoomt = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  function Immutable () {
    ...
    return function () {
      ...
      var struct = {};
      $_cga97x16zjeajooh4.each(fields, function (name, i) {
        struct[name] = $_c6ztc171jeajoohc.constant(values[i]);
      });
      return struct;
    };
  }
  ...
  var validateStrArr = function (label, array) {
    if (!$_e989pj19ajeajoon4.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_cga97x16zjeajooh4.each(array, function (a) {
      if (!$_e989pj19ajeajoon4.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_cga97x16zjeajooh4.find(sorted, function (s, i) {
  ...
  function MixedBag (required, optional) {
    ...
    $_2565xg19fjeajoona.validateStrArr('required', required);
    $_2565xg19fjeajoona.validateStrArr('optional', optional);
    $_2565xg19fjeajoona.checkDupes(everything);
    return function (obj) {
      var keys = $_ewqay819ejeajoon8.keys(obj);
      var allReqd = $_cga97x16zjeajooh4.forall(required, function (req) {
        return $_cga97x16zjeajooh4.contains(keys, req);
      });
      if (!allReqd)
        $_2565xg19fjeajoona.reqMessage(required, keys);
      var unsupported = $_cga97x16zjeajooh4.filter(keys, function (key) {
        return !$_cga97x16zjeajooh4.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_2565xg19fjeajoona.unsuppMessage(unsupported);
      var r = {};
      $_cga97x16zjeajooh4.each(required, function (req) {
        r[req] = $_c6ztc171jeajoohc.constant(obj[req]);
      });
      $_cga97x16zjeajooh4.each(optional, function (opt) {
        r[opt] = $_c6ztc171jeajoohc.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? Option.some(obj[opt]) : Option.none());
      });
      return r;
    };
  }

  var $_a28ufi19bjeajoon5 = {
    immutable: Immutable,
  ...
  var $_fcyjno19gjeajoonc = { toArray: toArray };

  var node = function () {
    var f = $_2a4rct17zjeajookf.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_ahq2ie19mjeajoonn.unknown()
    });
  };
  ...
  var $_dtespz19ljeajoonl = {
    unknown: unknown$1,
    nu: nu$1,
    edge: $_c6ztc171jeajoohc.constant(edge),
    chrome: $_c6ztc171jeajoohc.constant(chrome),
    ie: $_c6ztc171jeajoohc.constant(ie),
    opera: $_c6ztc171jeajoohc.constant(opera),
    firefox: $_c6ztc171jeajoohc.constant(firefox),
    safari: $_c6ztc171jeajoohc.constant(safari)
  };
  ...
  var $_4klqzp19njeajoono = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_c6ztc171jeajoohc.constant(windows$1),
    ios: $_c6ztc171jeajoohc.constant(ios),
    android: $_c6ztc171jeajoohc.constant(android),
    linux: $_c6ztc171jeajoohc.constant(linux),
    osx: $_c6ztc171jeajoohc.constant(osx),
    solaris: $_c6ztc171jeajoohc.constant(solaris),
    freebsd: $_c6ztc171jeajoohc.constant(freebsd)
  };
  ...
  function DeviceType (os, browser, userAgent) {
    ...
    return {
      isiPad: $_c6ztc171jeajoohc.constant(isiPad),
      isiPhone: $_c6ztc171jeajoohc.constant(isiPhone),
      isTablet: $_c6ztc171jeajoohc.constant(isTablet),
      isPhone: $_c6ztc171jeajoohc.constant(isPhone),
      isTouch: $_c6ztc171jeajoohc.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_c6ztc171jeajoohc.constant(iOSwebview)
    };
  }

  var detect$1 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_cga97x16zjeajooh4.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_ahq2ie19mjeajoonn.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_ahq2ie19mjeajoonn.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_exrws619sjeajooo6.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_exrws619sjeajooo6.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_exrws619sjeajooo6.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_exrws619sjeajooo6.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_3sizo319tjeajooo8.head(str).bind(function (head) {
      return $_3sizo319tjeajooo8.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_2l3nj919rjeajooo5.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_2l3nj919rjeajooo5.contains(uastring, 'edge/') && $_2l3nj919rjeajooo5.contains(uastring, 'chrome') && $_2l3nj919rjeajooo5.contains(uastring, 'safari') && $_2l3nj919rjeajooo5.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_2l3nj919rjeajooo5.contains(uastring, 'chrome') && !$_2l3nj919rjeajooo5.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_2l3nj919rjeajooo5.contains(uastring, 'msie') || $_2l3nj919rjeajooo5.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_2l3nj919rjeajooo5.contains(uastring, 'safari') || $_2l3nj919rjeajooo5.contains(uastring, 'mobile/')) && $_2l3nj919rjeajooo5.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_2l3nj919rjeajooo5.contains(uastring, 'iphone') || $_2l3nj919rjeajooo5.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_73slag19qjeajooo1 = {
    browsers: $_c6ztc171jeajoohc.constant(browsers),
    oses: $_c6ztc171jeajoohc.constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_73slag19qjeajooo1.browsers();
    var oses = $_73slag19qjeajooo1.oses();
    var browser = $_buwcbt19pjeajoons.detectBrowser(browsers, userAgent).fold($_dtespz19ljeajoonl.unknown, $_dtespz19ljeajoonl.nu);
    var os = $_buwcbt19pjeajoons.detectOs(oses, userAgent).fold($_4klqzp19njeajoono.unknown, $_4klqzp19njeajoono.nu);
  ...
  var $_1i70nr19kjeajoonk = { detect: detect$2 };

  var detect$3 = $_6cye9r196jeajoomv.cached(function () {
    var userAgent = navigator.userAgent;
    return $_1i70nr19kjeajoonk.detect(userAgent);
  });
  var $_7d0vs019jjeajoonj = { detect: detect$3 };

  var ELEMENT = $_bu05sy198jeajoomx.ELEMENT;
  var DOCUMENT = $_bu05sy198jeajoomx.DOCUMENT;
  ...
  var all = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_cga97x16zjeajooh4.map(base.querySelectorAll(selector), $_7xp0dh192jeajoomn.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? Option.none() : Option.from(base.querySelector(selector)).map($_7xp0dh192jeajoomn.fromDom);
  };
  var $_153ao419ujeajooo9 = {
    all: all,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_cga97x16zjeajooh4.exists(elements, $_c6ztc171jeajoohc.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_5momth19ijeajooni.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_7d0vs019jjeajoonj.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_83m01b19hjeajoond = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_153ao419ujeajooo9.is
  };

  var owner = function (element) {
    return $_7xp0dh192jeajoomn.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_7xp0dh192jeajoomn.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_7xp0dh192jeajoomn.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return Option.from(dom.parentNode).map($_7xp0dh192jeajoomn.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children(p);
      return $_cga97x16zjeajooh4.findIndex(kin, function (elem) {
        return $_83m01b19hjeajoond.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_e989pj19ajeajoon4.isFunction(isRoot) ? isRoot : $_c6ztc171jeajoohc.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_7xp0dh192jeajoomn.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return $_cga97x16zjeajooh4.filter(elements, function (x) {
        return !$_83m01b19hjeajoond.eq(element, x);
      });
    };
  ...
  var offsetParent = function (element) {
    var dom = element.dom();
    return Option.from(dom.offsetParent).map($_7xp0dh192jeajoomn.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.previousSibling).map($_7xp0dh192jeajoomn.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.nextSibling).map($_7xp0dh192jeajoomn.fromDom);
  };
  var prevSiblings = function (element) {
    return $_cga97x16zjeajooh4.reverse($_fcyjno19gjeajoonc.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_fcyjno19gjeajoonc.toArray(element, nextSibling);
  };
  var children = function (element) {
    var dom = element.dom();
    return $_cga97x16zjeajooh4.map(dom.childNodes, $_7xp0dh192jeajoomn.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return Option.from(children[index]).map($_7xp0dh192jeajoomn.fromDom);
  };
  ...
  var spot = $_a28ufi19bjeajoon5.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_7aem53199jeajoomx = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants($_1pd7f6195jeajoomt.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return $_cga97x16zjeajooh4.filter($_7aem53199jeajoomx.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_cga97x16zjeajooh4.filter($_7aem53199jeajoomx.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_cga97x16zjeajooh4.filter($_7aem53199jeajoomx.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    $_cga97x16zjeajooh4.each($_7aem53199jeajoomx.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_153ao419ujeajooo9.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_dre2le194jeajoomr.ancestors(scope, function (e) {
      return $_153ao419ujeajooo9.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_dre2le194jeajoomr.siblings(scope, function (e) {
      return $_153ao419ujeajooo9.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_dre2le194jeajoomr.children(scope, function (e) {
      return $_153ao419ujeajooo9.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_153ao419ujeajooo9.all(selector, scope);
  };
  var $_ars278193jeajoomq = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return $_cga97x16zjeajooh4.map($_ars278193jeajoomq.descendants($_7xp0dh192jeajoomn.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_2lflq7191jeajoomm.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$4('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_c6ztc171jeajoohc.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_cga97x16zjeajooh4.map($_cga97x16zjeajooh4.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_cga97x16zjeajooh4.map($_cga97x16zjeajooh4.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$3 = function (elm) {
    ...
    return $_cga97x16zjeajooh4.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_g5mjs0190jeajoomf = { find: find$3 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_c6ztc171jeajoohc.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_cga97x16zjeajooh4.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_cga97x16zjeajooh4.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_cga97x16zjeajooh4.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_cga97x16zjeajooh4.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_cga97x16zjeajooh4.indexOf(items, url) === -1) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_g5mjs0190jeajoomf.find(bodyElm);
  ...
  function ClosestOrAncestor (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? Option.some(scope) : $_e989pj19ajeajoon4.isFunction(isRoot) && isRoot(scope) ? Option.none() : ancestor(scope, a, isRoot);
  }

  var first$1 = function (predicate) {
    return descendant($_1pd7f6195jeajoomt.body(), predicate);
  };
  var ancestor = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_7xp0dh192jeajoomn.fromDom(element);
      if (predicate(el))
  ...
  var sibling = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return Option.none();
    return child$1($_7xp0dh192jeajoomn.fromDom(element.parentNode), function (x) {
      return !$_83m01b19hjeajoond.eq(scope, x) && predicate(x);
    });
  };
  var child$1 = function (scope, predicate) {
    var result = $_cga97x16zjeajooh4.find(scope.dom().childNodes, $_c6ztc171jeajoohc.compose(predicate, $_7xp0dh192jeajoomn.fromDom));
    return result.map($_7xp0dh192jeajoomn.fromDom);
  };
  var descendant = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_7xp0dh192jeajoomn.fromDom(element.childNodes[i])))
          return Option.some($_7xp0dh192jeajoomn.fromDom(element.childNodes[i]));
  ...
  var first$2 = function (selector) {
    return $_153ao419ujeajooo9.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_cmg8fc1a0jeajoool.ancestor(scope, function (e) {
      return $_153ao419ujeajooo9.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_cmg8fc1a0jeajoool.sibling(scope, function (e) {
      return $_153ao419ujeajooo9.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_cmg8fc1a0jeajoool.child(scope, function (e) {
      return $_153ao419ujeajooo9.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_153ao419ujeajooo9.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_153ao419ujeajooo9.is, ancestor$1, scope, selector, isRoot);
  };
  var $_bup45d19zjeajoook = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
      ...
      menu: [
        {
          text: 'Left',
          icon: 'alignleft',
          onclick: $_3ril2p1a3jeajooou.toggleFormat(editor, 'alignleft')
        },
        {
          text: 'Center',
          icon: 'aligncenter',
          onclick: $_3ril2p1a3jeajooou.toggleFormat(editor, 'aligncenter')
        },
        {
          text: 'Right',
          icon: 'alignright',
          onclick: $_3ril2p1a3jeajooou.toggleFormat(editor, 'alignright')
        },
        {
          text: 'Justify',
          icon: 'alignjustify',
          onclick: $_3ril2p1a3jeajooou.toggleFormat(editor, 'alignjustify')
        }
      ]
    });
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: item[0],
        cmd: item[1],
        onPostRender: $_3ril2p1a3jeajooou.postRenderFormat(editor, name)
      });
    });
  };
  var $_g6f6td1a2jeajooot = { register: register };
  ...
  var getFontProp = function (propName) {
    return function (rootElm, elm) {
      return Option.from(elm).map($_7xp0dh192jeajoomn.fromDom).filter($_fvv2jq197jeajoomw.isElement).bind(function (element) {
        return getSpecifiedFontProp(propName, rootElm, element.dom()).or(getComputedFontProp(propName, element.dom()));
      }).getOr('');
    };
  };
  var $_fdavcv1a5jeajooox = {
    getFontSize: getFontProp('fontSize'),
    getFontFamily: $_c6ztc171jeajoohc.compose(normalizeFontFamily, getFontProp('fontFamily')),
    toPt: toPt
  };
  ...
  var createFontNameListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        var fontFamily = $_fdavcv1a5jeajooox.getFontFamily(editor.getBody(), e.element);
  ...
  var $_1g6ctd1a4jeajooov = { register: register$1 };
  ...
  var createFontSizeListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        ...
        px = $_fdavcv1a5jeajooox.getFontSize(editor.getBody(), e.element);
        if (px) {
          for (precision = 3; !match && precision >= 0; precision--) {
            pt = $_fdavcv1a5jeajooox.toPt(px, precision);
  ...
  var $_4vhjbh1a6jeajoop0 = { register: register$2 };
  ...
  var createFormatMenu = function (editor) {
    ...
    return {
      ...
      itemDefaults: {
        ...
        onclick: function () {
          if (this.settings.format) {
            $_3ril2p1a3jeajooou.toggleFormat(editor, this.settings.format)();
          }
  ...
  var $_9b3ncc1a7jeajoop2 = { register: register$3 };
      ...
      return {
        ...
        onselect: function (e) {
          if (e.control) {
            ...
            $_3ril2p1a3jeajooou.toggleFormat(editor, fmt)();
          }
        },
  ...
  var buildMenuItems = function (editor, blocks) {
    return Tools.map(blocks, function (block) {
      return {
        text: block[0],
        onclick: $_3ril2p1a3jeajooou.toggleFormat(editor, block[1]),
        textStyle: function () {
          return editor.formatter.getCssText(block[1]);
        }
      };
  ...
  var $_cwvw0a1a8jeajoop5 = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_cga97x16zjeajooh4.flatten(Tools.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_cga97x16zjeajooh4.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_cga97x16zjeajooh4.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_e7gbf41a9jeajoop7 = { register: register$5 };
  ...
  var registerFormatButtons = function (editor) {
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: text,
        onPostRender: $_3ril2p1a3jeajooou.postRenderFormat(editor, name),
        onclick: $_3ril2p1a3jeajooou.toggleFormat(editor, name)
      });
    });
  };
  ...
  var registerMenuItems$1 = function (editor) {
    ...
    editor.addMenuItem('codeformat', {
      text: 'Code',
      icon: 'code',
      onclick: $_3ril2p1a3jeajooou.toggleFormat(editor, 'code')
    });
  };
  ...
  var $_66oz3l1aajeajoope = { register: register$6 };
  ...
  var $_9pua01abjeajooph = { register: register$7 };
  ...
  var $_fdk0e1acjeajoopj = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      Env.container = $_bup45d19zjeajoook.descendant($_7xp0dh192jeajoomn.fromDom(document.body), editor.settings.ui_container).fold($_c6ztc171jeajoohc.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_cwvw0a1a8jeajoop5.register(editor);
    $_g6f6td1a2jeajooot.register(editor);
    $_66oz3l1aajeajoope.register(editor);
    $_9pua01abjeajooph.register(editor);
    $_4vhjbh1a6jeajoop0.register(editor);
    $_1g6ctd1a4jeajooov.register(editor);
    $_9b3ncc1a7jeajoop2.register(editor);
    $_fdk0e1acjeajoopj.register(editor);
    $_e7gbf41a9jeajoop7.register(editor);
  };
  var $_361uy719yjeajoooh = { setup: setup };
  ...
  var Slider = Widget.extend({
    init: function (settings) {
      ...
      self._minValue = $_e989pj19ajeajoon4.isNumber(settings.minValue) ? settings.minValue : 0;
      self._maxValue = $_e989pj19ajeajoon4.isNumber(settings.maxValue) ? settings.maxValue : 100;
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_eh56an17fjeajooiy,
      Control: Control$1,
      Factory: Factory,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_ju1lm17tjeajook6,
      Panel: Panel,
      Movable: $_ci4cir17hjeajooj1,
      Resizable: $_h29sx17ujeajook8,
      ...
      FormatControls: $_361uy719yjeajoooh,
  ...
  ThemeManager.add('inlite', function (editor) {
    var panel = create$3();
    $_361uy719yjeajoooh.setup(editor);
    $_1spjsc17wjeajookb.addToEditor(editor, panel);
    return $_bugvao16djeajoog8.get(editor, panel);
  });
  function Theme () {
  }
