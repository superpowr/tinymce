...
var contextmenu = (function () {
  ...
  var $_1ij8m5a2jeajoirn = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_fiaelya1jeajoirm.getContextMenu(editor);
  ...
  var $_avve1aa5jeajoirp = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_fiaelya1jeajoirm.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_avve1aa5jeajoirp.show(editor, $_1ij8m5a2jeajoirn.getPos(editor, e), visibleState, menu);
    });
  };
  var $_2umps4a0jeajoirl = { setup: setup };

  PluginManager.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_2umps4a0jeajoirl.setup(editor, visibleState, menu);
    return $_e36d5x9zjeajoirk.get(visibleState);
  });
  function Plugin () {
  }
