...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_dsexpsi6jeajojz2.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_dsexpsi6jeajojz2.getPreviewDialogWidth(editor);
    var dialogHeight = $_dsexpsi6jeajojz2.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_burnati7jeajojz3.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_b3n6zai4jeajojz1 = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_b3n6zai4jeajojz1.open(editor);
    });
  };
  var $_5eqcofi3jeajojz0 = { register: register };
  ...
  var $_epk0eoi9jeajojz5 = { register: register$1 };

  PluginManager.add('preview', function (editor) {
    $_5eqcofi3jeajojz0.register(editor);
    $_epk0eoi9jeajojz5.register(editor);
  });
  function Plugin () {
  }
