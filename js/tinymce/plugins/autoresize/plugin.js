...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_7yekoo8cjeajoiki.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_7yekoo8cjeajoiki.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_7yekoo8cjeajoiki.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_7yekoo8cjeajoiki.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_7yekoo8cjeajoiki.getAutoResizeBottomMargin(editor);
    ...
    if ($_7yekoo8cjeajoiki.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_a3l0fq89jeajoike.resize(editor, oldSize);
    });
  };
  var $_2k73ni88jeajoikc = { register: register };

  PluginManager.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_2k73ni88jeajoikc.register(editor, oldSize);
      $_a3l0fq89jeajoike.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
