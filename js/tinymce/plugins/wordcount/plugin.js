...
var wordcount = (function () {
  ...
  var $_fznnsps4jeajolmf = {
    each: each,
    map: map
  };

  var SETS$1 = $_aa1zq5s2jeajolma.SETS;
  var OTHER = $_aa1zq5s2jeajolma.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_fznnsps4jeajolmf.map(string.split(''), memoized);
  };
  var $_a59gnss3jeajolmd = { classify: classify };

  var ci = $_aa1zq5s2jeajolma.characterIndices;
  ...
  var $_gfs8dks5jeajolmh = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_aa1zq5s2jeajolma.EMPTY_STRING;
  var WHITESPACE$1 = $_aa1zq5s2jeajolma.WHITESPACE;
  var PUNCTUATION$1 = $_aa1zq5s2jeajolma.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_a59gnss3jeajolmd.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_gfs8dks5jeajolmh.isWordBoundary(map, i)) {
  ...
  var $_b644t6s1jeajolm8 = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_b644t6s1jeajolm8.getWords(getTextContent(editor)).length;
  };
  var $_3xugwqs0jeajolm6 = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_3xugwqs0jeajolm6.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_al81n2rzjeajolm5 = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return I18n.translate([
        '{0} words',
        $_3xugwqs0jeajolm6.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_6de7yls6jeajolmk = { setup: setup };

  PluginManager.add('wordcount', function (editor) {
    $_6de7yls6jeajolmk.setup(editor);
    return $_al81n2rzjeajolm5.get(editor);
  });
  function Plugin () {
  }
