...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_2swzc29njeajoips.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_c02kt39jjeajoiok.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_9huaqq9ljeajoiom.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_lp14q9ojeajoipu = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_6odo809ijeajoioj = {
    open: function (editor) {
      var minWidth = $_c02kt39jjeajoiok.getDialogMinWidth(editor);
      var minHeight = $_c02kt39jjeajoiok.getDialogMinHeight(editor);
      var currentLanguage = $_lp14q9ojeajoipu.getCurrentLanguage(editor);
      var currentLanguages = $_lp14q9ojeajoipu.getLanguages(editor);
      var currentCode = $_9huaqq9ljeajoiom.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_9huaqq9ljeajoiom.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_2swzc29njeajoips.isCodeSample(node)) {
        $_6odo809ijeajoioj.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_bwa2bm9hjeajoioi = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_2swzc29njeajoips.trimArg($_2swzc29njeajoips.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_2swzc29njeajoips.trimArg($_2swzc29njeajoips.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_ebnsue9pjeajoipx = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_c02kt39jjeajoiok.getContentCss(editor);
  ...
  var $_d0odvz9qjeajoipz = { loadCss: loadCss };
  ...
  var $_dd3k559rjeajoiq0 = { register: register$1 };

  var addedInlineCss = Cell(false);
  PluginManager.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_ebnsue9pjeajoipx.setup(editor);
    $_dd3k559rjeajoiq0.register(editor);
    $_bwa2bm9hjeajoioi.register(editor);
    editor.on('init', function () {
      $_d0odvz9qjeajoipz.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_2swzc29njeajoips.isCodeSample(ev.target)) {
        $_6odo809ijeajoioj.open(editor);
      }
    });
  });
